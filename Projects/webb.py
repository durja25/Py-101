...
# This is our list for usernames we want to try on the webapp
usernames = ["admin", "user", "test"]
# This is going to be our password file
passwords = "./common.txt"
needle = "welcome back"  # success text
    ...
    with open(passwords, "r", encoding='latin-1') as password_list:
        try:
            for password in password_list:
                ...
                sys.stdout.flush()  # We need to clear the buffer after we write the file
