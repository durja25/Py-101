...
# There is nothing that's false so this condition won't execute.
if False:
...
# This is another example of a condition that won't execute and therefore, the code inside it is unreachable
if 1 < 1:
    print("1 < 1")
elif 1 <= 1:
    # elif/ else-if is a way of giving another condition to execute in case the other statements are not
    # reachable
    print("1 <= 1")
...
if 1 < 1:
    ...
    # Because this condition is true and comes first this is printed.
    print("1 <= 1")
elif 2 <= 2:
    # Despite the fact that the condition is true, it won't be executed as the first elif statement is
    # executed first
    print("2 <= 2")
else:
    print("else reached")
...
if (1 < 0 or 0 < 1) and 1 == 1:
    # This is us just playing with operators. As long as the last calculation is true,
...
# This is just another way to write our ternary statement
if 1 >= 1:
    print("1 >= 1")
else:
    print("1 < 1")
...
# This is the same operation as the one above.
