...
# This is another thing we can check if it is true
print((10 < 9) == True)
print((10 == 10) == True)
print((10 != 10) == True)
print((10 >= 10) == True)
...
# We don't necessarily need the true boolean sign to get the results
print((10 < 9))
print((10 == 10))
print((10 != 10))
print((10 >= 10))
...
# We can compare two or more statements using operators in Python.
print(10 > 5 and 10 < 5)
print(10 > 5 or 10 < 5)

# Boolean of 0 represents False
print(bool(0))
# Boolean of 0 represents True
print(bool(1))

# You can use Python to perform arithmetic calculations.
print(10 + 10)
print(10 - 10)
print(10 / 10)
# The // sign represents floor division
# if you don't want ans in float
print(10 // 10)

# returns float
print(10 / 3)
# returns int or round number
print(10 // 3)
...
# This is the short form version of x = x + 1
# syntactic sugar
x += 1
print(x)
x -= 1
...
print(bin(x))
# This cancels the 0b part out of the binary representation. We will learn why later.
...
# This analyzes the binaries bit by bit and shows whether the final is 0 or 1.
...
## bitwise shift ##
# x >> 1 means perform a bitwise shift of one. It means we moved all the bits
