...
for i in range(5):
    if i == 2:
        continue
        # This will skip the given condition then goes back to the start of the loop and reiterates the
...
for i in range(5):
    if i == 2:
        pass
        # Similar to the continue statement but it does not reiterrate anything, it just passes the condition
        # and lets the loop finish.
    print(i)

    for c in "string":
        # We can iterate over each individual string
        print(c)

    for key, value in {"A": 1, "B": 2, "C": 3}.items():
        # We can iterate over each item in a dictionary
        print(key, value)
